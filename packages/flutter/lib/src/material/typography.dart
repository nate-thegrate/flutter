...
class Typography with Diagnosticable {
  ...
  factory Typography.material2021({
    ...
    final Color dark = colorScheme.brightness.isLight ? colorScheme.onSurface : colorScheme.surface;
    final Color light = colorScheme.brightness.isLight ? colorScheme.surface : colorScheme.onSurface;
