...
class Typography with Diagnosticable {
  ...
  factory Typography.material2021({
    ...
    final (Color dark, Color light) = switch (colorScheme.brightness) {
      Brightness.light => (colorScheme.onSurface, colorScheme.surface),
      Brightness.dark  => (colorScheme.surface, colorScheme.onSurface),
    };
