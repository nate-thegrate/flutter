...
class DrawerControllerState extends State<DrawerController> with SingleTickerProviderStateMixin {
  ...
  Widget _buildDrawer(BuildContext context) {
    ...
    final double dragAreaWidth = widget.edgeDragWidth ?? _kEdgeDragWidth + switch ((textDirection, drawerIsStart)) {
      (TextDirection.ltr, true) || (TextDirection.rtl, false) => MediaQuery.paddingOf(context).left,
      (TextDirection.rtl, true) || (TextDirection.ltr, false) => MediaQuery.paddingOf(context).right,
    };
