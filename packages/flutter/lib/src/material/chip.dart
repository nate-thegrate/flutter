  ...
  void performLayout() {
    ...
    Offset centerLayout(Size boxSize, double x) {
      ...
      return switch (textDirection!) {
        TextDirection.rtl => Offset(x - boxSize.width, (sizes.content - boxSize.height + sizes.densityAdjustment.dy) / 2.0),
        TextDirection.ltr => Offset(x, (sizes.content - boxSize.height + sizes.densityAdjustment.dy) / 2.0),
      };
    }
