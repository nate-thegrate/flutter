...
class AnimatedPadding extends AnimatedValue<EdgeInsetsGeometry> {
  ...
  AnimatedPadding({
    ...
    EdgeInsetsGeometry? initialPadding,
    super.curve,
    required super.duration,
    super.onEnd,
    super.child,
  }) : assert(padding.isNonNegative),
       super(value: padding, initialValue: initialPadding, lerp: EdgeInsetsGeometry.lerp);
...
class AnimatedAlign extends AnimatedValue<_AlignProperties> {
  ...
  const AnimatedAlign({
    ...
    super.child,
       ...
       super(
         value: (alignment: alignment, heightFactor: heightFactor, widthFactor: widthFactor),
         initialValue: initialAlignment != null
             ? (alignment: initialAlignment, heightFactor: heightFactor, widthFactor: widthFactor)
             : null,
...
class AnimatedOpacity extends AnimatedValue<double> {
  ...
  const AnimatedOpacity({
    ...
    super.child,
       ...
       super(value: opacity, initialValue: initialOpacity, lerp: ui.lerpDouble);
...
class AnimatedDefaultTextStyle extends AnimatedValue<TextStyle> {
  ...
  const AnimatedDefaultTextStyle({
    ...
    required Widget super.child,
       ...
       super(value: style, lerp: TextStyle.lerp);
...
class AnimatedPhysicalModel extends AnimatedValue<_PhysicalModelProperties> {
  ...
  const AnimatedPhysicalModel({
    ...
    required Widget super.child,
       ...
       super(
         value: (borderRadius: borderRadius, elevation: elevation, color: color, shadowColor: shadowColor),
         lerp: _lerpProperties,
       );
...
class AnimatedFractionallySizedBox extends AnimatedValue<_FractionallySizedBoxProperties> {
  ...
  const AnimatedFractionallySizedBox({
    ...
    super.child,
       ...
       assert(heightFactor == null || heightFactor >= 0.0),
       super(
         value: (alignment: alignment, width: widthFactor, height: heightFactor),
         lerp: _lerpProperties,
       );
