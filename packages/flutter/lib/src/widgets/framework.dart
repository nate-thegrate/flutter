...
abstract class Element extends DiagnosticableTree implements BuildContext {
  ...
  T? findAncestorWidgetOfExactType<T extends Widget>() {
    ...
    for (Element? ancestor = _parent; ancestor != null; ancestor = ancestor._parent) {
      if (ancestor.widget case final T widget when widget.runtimeType == T) {
        return widget;
      }
    }
    return null;
...
abstract class RenderObjectElement extends Element {
  ...
  List<ParentDataElement<ParentData>> _findAncestorParentDataElements() {
    ...
    Element? ancestor;
    for (ancestor = _parent; ancestor != null && ancestor is! RenderObjectElement; ancestor = ancestor._parent) {
