...
class SampleChecker {
  ...
  List<File> getFiles(Directory directory, [Pattern? filenamePattern]) {
    bool matchesPattern(File file) => filenamePattern == null || file.absolute.path.contains(filenamePattern);

    return <File>[
      for (final FileSystemEntity entity in directory.listSync(recursive: true))
        if (entity case final File file when matchesPattern(file)) file,
    ];
  }
